 ...
 */
final class Version20210916185457 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Ajout ligne detail commande';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE purchase_line (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
